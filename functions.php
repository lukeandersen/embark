...
function embark_scripts() {
    ...
    wp_enqueue_script( 'modernizr', THEME_URI .'/js/libs/modernizr-min.js', array(),'2.6.1', false);
    // jQuery
    wp_deregister_script( 'jquery' );
    wp_register_script('jquery', THEME_URI .'/js/libs/jquery-1.8.3.min.js', array(), '1.8.3', true );
